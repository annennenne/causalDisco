...
This document is intended for developers maintaining or extending this project.
...
- When wrapping external libraries (e.g., Tetrad), prefer concise documentation
