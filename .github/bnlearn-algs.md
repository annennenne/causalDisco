...
This document tracks bnlearn algorithms with respect to their status in this
...
since they always returns DAGs (even when causal direction is not possible to
infer).
