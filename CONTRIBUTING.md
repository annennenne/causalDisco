...
Contributions are welcome and appreciated! Thank you for taking the time
...
If you’ve found a bug, please open an issue and provide a minimal
working example (MWE; see also [reprex](https://reprex.tidyverse.org/))
when possible.

If you’re planning to add a new feature or make a significant change,
it’s a good idea to open an issue first to discuss it before starting
work. This helps ensure alignment and avoids duplicate effort.
