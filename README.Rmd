...
Atm we have a mix of both styles, so hard for user to know which to use (especially if their starting point is our package). We decided to use our own naming (snake_case).

- Allow user to specify engines without being casesensitive? E.g. "TETRAD", "tetrad", "TeTrAd" should all work.

## TODO

Rewrite knowledge required + forbidden to use caugi style with `%-->%` instead of `~` (and also `%<--%`).
