...
- Don't clash namespaces with caug. We currently share `nodes()` and `edges()`.
Make PR in caugi that makes their `nodes()` and `edges()` it a S3/S7 class? Opened a PR in caugi to do this.
