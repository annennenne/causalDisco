...
- What should plot knowledge do if only some variables have a tier? Currently just made it plot the missing tiers
as it's own tier to the right, but this is misleading?
