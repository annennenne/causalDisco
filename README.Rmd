...
- Currently impossible to set arguments to our `_run` functions through the high-level interface `tpc`, ... It's handled by `check_args_and_distribute_args` which calls `check_args_and_distribute_args_causalDisco`. 
So fix this...
