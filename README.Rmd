...
```{r bnlearn pc undirected fix}
pc_bn <- bnlearn::pc.stable(data_simple, test = "zf", alpha = 0.05)
plot(pc_bn)
```

Problem is `knowledgeable_caugi()` incorrectly converts the `bnlearn` object to `caugi` object,
losing the undirected edges. Fixed in PR #149 in caugi.
