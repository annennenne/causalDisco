...
causal discovery algorithms. To use algorithms from `Tetrad` you need to install JDK 21 (or newer) by
following [this guide](https://github.com/cmu-phil/tetrad/wiki/Setting-up-Java-for-Tetrad),
