...
If you want to use algorithms from Tetrad, you also need to install the suggested dependency
(rJava and a Java JDK >= 21). See below for instructions on how to set up Java and Tetrad.
...
the the R packages bnlearn and pcalg, and the Java library Tetrad with a consistent syntax. Here we provide
