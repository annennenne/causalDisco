...
Here we run a causal discovery algorithm to get a `knowledgeable_caugi`,
which is the knowledge object alongside the learned causal graph as a
`caugi` object. We can then plot this combined object to see both the
prior knowledge and the learned relationships
...
#> %%% Generated by causalDisco (version 0.9.5.9051)
