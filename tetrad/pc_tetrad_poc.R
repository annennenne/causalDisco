...
.jaddClassPath("/home/fabben/BioStat/py-tetrad/pytetrad/resources/tetrad-current.jar")
.jclassPath()


# data <- read.table("pytetrad/resources/airfoil-self-noise.continuous.txt", header=TRUE)
data <- read.table("~/BioStat/py-tetrad/pytetrad/resources/example_sim_100-6-1000.txt", header=TRUE)
