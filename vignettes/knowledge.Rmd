...
All knowledge types are supported with bnlearn engine. Note, that you can get a
...
WIP. Currently causalDisco only works correctly with tiered and forbidden knowledge.
