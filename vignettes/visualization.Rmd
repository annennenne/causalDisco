...
`knowledgeable_caugi` objects, customizing layouts and styles, and exporting graphs to readable TikZ for inclusion and
...
Here we run a causal discovery algorithm to get a `knowledgeable_caugi`, which is the knowledge object alongside the
...
This functionality works for `knowledge`, `knowledgeable_caugi`, and `caugi::caugi` objects, allowing you to customize
