...
load(url(
  "https://github.com/annennenne/causalDisco/raw/master/webtool/data/exampledata_catData.rda"
))
...
bnstruct_mmhc_out <- learn.network(bnstruct_catData, algo = "mmhc")
