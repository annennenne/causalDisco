...
load(url(
  "https://github.com/annennenne/causalDisco/raw/master/webtool/data/exampledata_catData_mcar.rda"
))
...
bnstruct_catData_mcar <- BNDataset(
  catData_mcar_asNumbers,
...
bnstruct_sem_out <- learn.network(bnstruct_catData_mcar, algo = "sem")
