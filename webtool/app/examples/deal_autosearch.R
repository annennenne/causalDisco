...
load(url(
  "https://github.com/annennenne/causalDisco/raw/master/webtool/data/exampledata_mixData.rda"
))
...
#Learn causal structure using autosearch()
#Mandatory arguments:
...
deal_autosearch_out <- autosearch(deal_net_wpar, mixData, deal_jointprior)


#Extract network with best score:
deal_autosearch_outnet <- deal_autosearch_out$nw

#Print chosen network
deal_autosearch_outnet

#Plot chosen network
plot(deal_autosearch_outnet)
