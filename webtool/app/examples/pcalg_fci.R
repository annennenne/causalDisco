...
load(url(
  "https://github.com/annennenne/causalDisco/raw/master/webtool/data/exampledata_numData_latent.rda"
))
...
pcalg_suffstat_numData_latent <- list(
  C = cor(numData_latent),
  n = nrow(numData_latent)
)

#Learn causal structure using fci()
#Mandatory arguments:
